          ...
          <div className="mt-16 grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <a 
                ...
                className="flex items-start gap-4 group bg-gray-50 border border-gray-200 rounded-lg p-6 hover:border-[#0A66C2] transition-colors"
              >
                <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 bg-[#E8F3FF] group-hover:bg-[#E1ECF4] transition-colors">
